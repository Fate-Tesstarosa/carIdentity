...
class char_cnn_net:
    def __init__(self):
        ...
        self.batch_size = 100
        self.x_place = tf.compat.v1.placeholder(dtype=tf.float32, shape=[None, self.img_size, self.img_size], name='x_place')
    ...
    def cnn_construct(self):
        ...
        cw1 = tf.Variable(tf.compat.v1.random_normal(shape=[3, 3, 1, 32], stddev=0.01), dtype=tf.float32)
        ...
        fw1 = tf.Variable(tf.compat.v1.random_normal(shape=[3 * 3 * 128, 1024], stddev=0.01), dtype=tf.float32)
        ...
        fw3 = tf.Variable(tf.compat.v1.random_normal(shape=[1024, self.dataset_len], stddev=0.01), dtype=tf.float32)
        fb3 = tf.Variable(tf.compat.v1.random_normal(shape=[self.dataset_len]), dtype=tf.float32)
